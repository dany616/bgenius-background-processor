...
program
    ...
    try {
        ...
        if (options.model)
            removalOptions.model = options.model;
        if (options.apiKey)
            removalOptions.apiKey = options.apiKey;
        if (options.precision)
            removalOptions.precision = options.precision;
...
program
    ...
    try {
        ...
        if (options.style)
            generationOptions.style = options.style;
        if (options.apiKey)
            generationOptions.apiKey = options.apiKey;
